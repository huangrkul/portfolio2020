...
import logoNews from "../../public/assets/homepage/logo-news.png";
...
const Homepage = (props) => {
  ...
  useEffect(() => {
    ...
    setAni(".logo-container img:nth-child(3)", 600, "logo-enter-hero");
    setAni(".title-container div:first-child", 1000, "logo-animate");
    setAni(
      ".title-container div:nth-child(2) img:first-child",
      1800,
      "huang-inbtm"
    );
    setAni(
      ".title-container div:nth-child(2) img:last-child",
      1800,
      "huang-intop"
    );
    setTimeout(() => {
    ...
    setAni(".logo-container img:last-child", 4200, "logo-enter");
  ...
  return (
    <article className="homepage">
      <section className="logo-title">
        <div>
          <section className="logo-container logo-enter-hero">
            ...
            <img className="hide" src={logoNews} />
          </section>
        </div>
        <div>
      ...
      <ul className="hide">
        <li className="hide" onClick={() => props.changePage("btnAbout")}>
          Profile
        </li>
        <li className="hide" onClick={() => props.changePage("btnProjects")}>
          Projects
        </li>
        <li className="hide" onClick={() => props.changePage("btnBanners")}>
          Banners
        </li>
        <li className="hide" onClick={() => props.changePage("btnDemo")}>
          Demos
        </li>
        <li className="hide" onClick={() => props.changePage("btnContact")}>
          Contact
        </li>
      </ul>
      <h6 className="hide">
        (Last updated: 4/19/21) Copyright &copy; 2021 William Huang /
        huangrkul@gmail.com. All Rights Reserved
      </h6>
    </article>
  );
};
